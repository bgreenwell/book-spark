...
\hypersetup{unicode=true,
            pdftitle={Distributed Machine Learning in R with Apache Spark: An Introduction Using sparklyr and rsparkling},
            pdfauthor={Yihui Xie},
            pdfborder={0 0 0},
            breaklinks=true}
...
\setlength{\droptitle}{-2em}
  ...
  \title{Distributed Machine Learning in R with Apache Spark: An Introduction
Using sparklyr and rsparkling}
